...
public interface DatabaseClient {
    ...
    void dropCollection(ServerConfiguration configuration, MongoCollection selectedCollection);

    void dropDatabase(ServerConfiguration configuration, MongoDatabase selectedDatabase);
}
