...
import org.codinjutsu.tools.nosql.view.model.JsonDataType;
import org.codinjutsu.tools.nosql.view.table.DateTimePicker;
...
public abstract class AbstractAddDialog extends DialogWrapper {
    ...
    private static class NumberFieldWrapper extends TextFieldWrapper<JTextField, Number> {
        ...
        public Number getValue() {
            return org.codinjutsu.tools.nosql.utils.StringUtils.parseNumber(component.getText());
        }
