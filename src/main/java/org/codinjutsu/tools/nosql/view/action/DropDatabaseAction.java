...
public class DropDatabaseAction extends AnAction implements DumbAware {
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        int result = JOptionPane.showConfirmDialog (null, String.format("Do you REALLY want to drop the '%s' database?", noSqlExplorerPanel.getSelectedDatabase().getName()),"Warning",JOptionPane.YES_NO_OPTION);
    ...
    public void update(AnActionEvent event) {
        event.getPresentation().setVisible(noSqlExplorerPanel.getSelectedDatabase() != null);
    }
}